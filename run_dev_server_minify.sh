...
google-closure-compiler -O ADVANCED --language_in UNSTABLE --warning_level QUIET --isolation_mode IIFE --assume_function_wrapper --emit_use_strict --js_output_file $OUT1 $IN1 $IN2
cp $OUT1 $OUT2
